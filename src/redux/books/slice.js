    ...
    builder
      ...
      .addCase(fetchRecommendedBooksAsync.rejected, (state, action) => {
        ...
        state.recommended.error =
          action.payload ||
          "An error occurred while loading the recommended books";
      })
      ...
      .addCase(fetchLimitedRecommendedBooksAsync.rejected, (state, action) => {
        ...
        state.limitedRecommended.error =
          action.payload ||
          "An error occurred while loading the filtered recommendations";
      })
      ...
      .addCase(fetchUserLibraryAsync.rejected, (state, action) => {
        state.library.isLoading = false;
        state.library.error =
          action.payload || "An error occurred while loading the library";
      })
      ...
      .addCase(removeBookFromLibraryAsync.rejected, (state, action) => {
        ...
        state.library.error =
          action.payload ||
          "An error occurred while removing the book from the library";
      })
      ...
      .addCase(startReadingSessionAsync.rejected, (state, action) => {
        state.reading.error =
          action.payload || "An error occurred while starting the read session";
      })
      ...
      .addCase(stopReadingSessionAsync.rejected, (state, action) => {
        state.reading.error =
          action.payload || "An error occurred while closing the read session";
      })
      ...
      .addCase(deleteReadingSession.rejected, (state, action) => {
        state.reading.error =
          action.payload || "An error occurred while deleting the read session";
      });
  },
});
